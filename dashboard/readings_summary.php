  ...
  <div class="page-content">
    ...
    <div class="panel">
      ...
      <div class="runs-table-wrap">
        <?php if (empty($runs)): ?>
          <div class="empty-state"><i class='bx bx-data'></i><p>No readings recorded yet.</p></div>
        <?php else: ?>
    ...
    <div class="panel">
      ...
      <?php if (empty($hourly)): ?>
        <div class="empty-state"><i class='bx bx-time'></i><p>No data in the last 12 hours.</p></div>
      <?php else: ?>
      <table class="data-table">
        <thead>
          <tr>
